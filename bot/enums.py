...
class StatusMessage(Enum):
    ...
    PROMO = "Привет! Я <b>NurVPNbot</b> — полностью бесплатный, без рекламы и обязательных подписок. Если тебе нравится моя работа, загляни на мой <b><a href='https://t.me/NurVPN_news'>телеграм канал с новостями</a></b> — это большая поддержка для меня! 😊\n\n<b>Это сообщение самоудалится через 10 секунд</b>"
